export const homeData = [
  {
    ...
    rating: 4.7,
    time: "1 hr : 52mins",
    desc: " paranormal investigators Ed and Lorraine Warren as they face a malevolent force tormenting a family.",
    starring: "Vira Farmiga, Patrick Wilson",
    genres: "horror",
...
export const trending = [
  {
    ...
    rating: 4.7,
    time: "serie",
    desc: "a group of teenagers go throw an adventure to find the One piece with their leader Luffy , and face multiple enemies and problems ",
    starring: "",
    genres: "Action",
    tags: "Action, Adventures, Horror",
